...
bool cstrcat(c_string *a, c_string *b)
{
    size_t sz1 = cstrlen(a), sz2 = cstrlen(b);
...
c_string init_cstrcpy(c_string *a, c_string *b)
{
    if (a != b)
    {
...
c_string cstrcpy(c_string *a, c_string *b)
{
    if (a != b)
    {
        free(a->data);
...
int cstrcmp(c_string *a, c_string *b)
{
    return strcmp(a->data, b->data);
}

size_t cstrcspn(c_string *a, c_string *b)
{
    return strcspn(a->data, b->data);
}

char *cstrstr(c_string *a, c_string *b)
{
    return strstr(a->data, b->data);
}

c_string cstr_substr(c_string *s, size_t start, size_t length)
{
    c_string res;
    res.capa = length + 1;
...
void cstr_print(c_string *s)
{
    printf("%s", s->data);
}

void cstr_fprint(FILE *fl, c_string *s)
{
    fprintf(fl, "%s", s->data);
}
...
int cstr_fscan(FILE *fl, c_string *s)
{
    int ch;
...
int cstr_fgets(c_string *s, FILE *stream)
{
    size_t i = 0;
    int ch;
...
bool cstr_fill(c_string *a, size_t start, c_string *b)
{
    size_t sz1 = cstrlen(a), sz2 = cstrlen(b);
    if (sz1 - start < sz2)
    {
...
bool cstr_reserve_cpy(c_string *s, size_t start, c_string *a)
{
